...
public class ProdutoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        edtPRO_ID = new javax.swing.JTextField();
        ...
        lblTitulo.setBounds(240, 80, 250, 29);

        lblPRO_ID.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPRO_ID.setText("ID");

        lblPRO_NOME.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPRO_NOME.setText("Nome");

        edtPRO_ID.setEditable(false);
        edtPRO_ID.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(edtPRO_ID, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(edtPRO_NOME, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(edtPRO_ID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblPRO_ID))
                .addGap(31, 31, 31)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblPRO_NOME)
    ...
    private void btnGRAVARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGRAVARActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma Gravação deste Produto ?",
            ...
            objproduto.setPRO_ID(Integer.parseInt(edtPRO_ID.getText()));
            objproduto.setPRO_NOME(edtPRO_NOME.getText());

            try {
                produtocontroller.gravar(objproduto, getOperacao());
    ...
    private void mostrar(ProdutoModel produto) {
        edtPRO_ID.setText(String.valueOf(produto.getPRO_ID()));
    ...
    private String filtrar() {
        ...
        if (!edtCONS_ID1.getText().trim().equals("")) {
            condicao += "(PRO_ID >= " + edtCONS_ID1.getText() + ")";
        }
        if (!edtCONS_ID2.getText().trim().equals("")) {
            if (!condicao.isEmpty()) {
                condicao += " AND ";
            }
            condicao += "(PRO_ID <= " + edtCONS_ID2.getText() + ")";
        }
    ...
    private javax.swing.JTextField edtPRO_ID;
